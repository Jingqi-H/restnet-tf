"""
这个main3.py文件，用的是迁移学习方法三中的，加载预训练模型，冻结了stage1，训练其他参数
还改了优化器的传参

区别于main3：这个没有数据增强，
区别于main3.2：没有dropout
"""
...
def cross_valid(
    ...
    for i in range(k_fold):
        ...
        save_dir = os.path.join(os.path.join('./result', date), 'main3.1')
        mkfile(save_dir)
...
if __name__ == '__main__':
    ...
    print('I am Tf3.1 with  on data with strip. / lr={} / wd={}.'.format(opt.lr, opt.weight_decay))
    ...
    save_dir = os.path.join(os.path.join('./result', opt.date), 'main3.1')
