...
def cross_valid(
    ...
    for i in range(k_fold):
        ...
        save_dir = os.path.join(os.path.join('./result', date), 'main3')
        mkfile(save_dir)
...
if __name__ == '__main__':
    ...
    print('I am Tf3 with  on data with strip. / lr={} / wd={}.'.format(opt.lr, opt.weight_decay))
    ...
    save_dir = os.path.join(os.path.join('./result', opt.date), 'main3')
