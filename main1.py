"""
这个main1.py文件，用的是迁移学习方法一中的，加载预训练模型，训练全部参数
"""
...
def cross_valid(
    ...
    for i in range(k_fold):
        ...
        save_dir = os.path.join(os.path.join('./result', date), 'main1')
        mkfile(save_dir)
...
if __name__ == '__main__':
    ...
    print('I am Tf1 with  on data with strip. / lr={} / wd={}.'.format(opt.lr, opt.weight_decay))
